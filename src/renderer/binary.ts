import type { ArrayType, BinaryArray, BinaryBase64, BinaryBlob, BinarySource, BinarySourceData } from ".";
...
export function isBinaryData(data: unknown): data is BinarySourceData {
...
export function getBufferData(data: BinarySourceData): ArrayBuffer {
