...
export function multiSample(renderer: Renderer) {
    ...
    const texParams = { target: "TEXTURE_2D", internalFormat: "RGBA8", type: "UNSIGNED_BYTE", width: w, height: h, image: null } as const;
    ...
    renderer.invalidateFrameBuffer({ frameBuffer: fbMultisample, color: [true] });
